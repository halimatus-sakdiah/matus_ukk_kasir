        ...
        include '../koneksi.php';
            ...
            while($d = mysqli_fetch_array($data))
                ...
                <tr>
                    ...
                    <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#edit-data<?= $d['pelanggan_id'] ?>" <?= $d['pelanggan_id']; ?>>Edit</button>

                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus-data<?= $d['pelanggan_id'] ?>" <?= $d['pelanggan_id']; ?> >Hapus</button>
                    </td>
                        ...
                        <form action="proses_update_pembelian.php" method="post">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="NoTelp" class="form-control" value="<?= $d['NoTelp']; ?>">
                                </div>
                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="proses_hapus_pembelian.php" method="post">
                            <div class="modal-body">
                                <input type="hidden" name="pelanggan_id" value="<?= $d['pelanggan_id']; ?>"> Apakah anda yakin akan menghapus data <b><?= $d['Nama']; ?></b>
                            </div>
                            <div class="modal-footer">
